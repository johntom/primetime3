...
//console.log('startemup');
         ...
         //   $scope.createBilling = function (trip) {
            $scope.createBilling = function (book) {
...
//__currentPage
           ...
           // $scope.aftersaveDetail = function (data) {
            ...
            $scope.removeItem = function (index) {
                var message = "You are about to delete " + $scope.currentBilling.details[index].type + ' ' + $scope.currentBilling.details[index].code + ". Are you sure ?";
                $scope.saveDetail($scope.billingitems.details, 0, 0);
                ...
                modalInstance.result.then(function () {
                    $scope.currentBilling.details.splice(index, 1);
                    $scope.aftersaveDetail($scope.currentBilling.details, 0);
                });
            };
