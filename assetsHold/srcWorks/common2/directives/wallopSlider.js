...
var wallopSlider = angular.module('directive.wallopSlider', [])
	...
	// this contrains the height needed for pt3
		.directive('wallopSliderPropor', ['$interval',function ($interval) {

			return {
				template: '<div class="wallop-slider {{animationClass}}"><ul class="wallop-slider__list"><li class="wallop-slider__item {{itemClasses[$index]}}" ng-repeat="i in images">' +
				'<img style="height:auto; width:auto; max-width:auto; max-height:650px;margin-left: auto;margin-right: auto;" src="{{i}}"></li></ul><button ng-show="images.length>1" class="wallop-slider__btn wallop-slider__btnwallop--previous btnwallop btnwallop--previous " ng-disabled="prevDisabled" ng-click="onPrevButtonClicked()">Previous</button> <button ng-show="images.length>1" class="wallop-slider__btnwallop wallop-slider__btnwallop--next btnwallop btnwallop--next" ng-disabled="nextDisabled" ng-click="onNextButtonClicked()">Next</button></div>',
...
////	'<img style="height:auto; width:auto; max-width:1000px; max-height:{{windowHeight}}px;margin-left: auto;margin-right: auto;" src="{{i}}"></li></ul><button ng-show="images.length>1" class="wallop-slider__btn wallop-slider__btnwallop--previous btnwallop btnwallop--previous " ng-disabled="prevDisabled" ng-click="onPrevButtonClicked()">Previous</button> <button ng-show="images.length>1" class="wallop-slider__btnwallop wallop-slider__btnwallop--next btnwallop btnwallop--next" ng-disabled="nextDisabled" ng-click="onNextButtonClicked()">Next</button></div>',
