...
angular.module('sailng.upload', [
    ...
    .config(['$stateProvider', function config($stateProvider) {
        ...
        .controller('UploadCtrl', ['$scope','$http',  'FileUploader', 'lodash', 'config', 'titleService',  '$filter', 'ngTableParams', '$location','GalleryModel', function UploadController($scope,$http, FileUploader, lodash, config, titleService,  $filter, ngTableParams, $location,GalleryModel) {
